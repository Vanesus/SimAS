...
public class Simulador extends javax.swing.JFrame {
       ...
       // this.jTable3.setVisible(false);
        ...
        if(this.metodoSimulacion == 2){
            if(this.metodoAscendente == 0){                
                this.jLabelSimulador.setText("Simulación Ascendente SLR");
            }
            if(this.metodoAscendente == 1){
                this.jLabelSimulador.setText("Simulación Ascendente LR-Canónico");
            }
            if(this.metodoAscendente == 2){
                this.jLabelSimulador.setText("Simulación Ascendente LALR");
            }
        ...
        if(this.metodoSimulacion == 1){
            this.jTable3.setVisible(false);
            this.jLabelSimulador.setText("Simulación Descendente");
    ...
    public Boolean generarInforme(String fichero) throws DocumentException{
        try {
            ...
            if(this.metodoSimulacion == 1)
                parrafo = new Paragraph("     INFORME DE LA SIMULACIÓN DESCENDENTE", titulo);
            if(this.metodoSimulacion == 2){                
                parrafo = new Paragraph("      INFORME DE LA SIMULACIÓN ASCENDENTE", titulo);
                if(this.metodoAscendente == 0)
                    met = new Paragraph("                         MÉTODO SLR         ", titulo);
                if(this.metodoAscendente == 1)
                    met = new Paragraph("                      MÉTODO LR-CANÓNICO         ", titulo);
                if(this.metodoAscendente == 2)
                    met = new Paragraph("                         MÉTODO LALR         ", titulo);
            }
            ...
            Paragraph col1 = new Paragraph("\n Colección Canónica Elementos LR(0) \n\n", font2);
            PdfPTable col2 = new PdfPTable(1);
            Paragraph accion = new Paragraph("   PARTE ACCIÓN \n\n", font5);
    ...
    private void initComponents() {
        ...
        jLabelAccion.setText("Parte Acción");
        ...
        jMenuItem1.setText("Nueva Simulación");
