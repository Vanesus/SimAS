    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        while(i<term.size()){
            if(this.tpredictiva.getCeldaPredictiva(fila, 0).toString().equals(term.get(i))){
                JOptionPane.showConfirmDialog(null, "Esta fila no se puede rellenar, debido a que el símbolo \""+term.get(i)+"\" no aparece en la parte derecha de una producción en un lugar que no sea el primero.", "Salir",JOptionPane.CLOSED_OPTION);
